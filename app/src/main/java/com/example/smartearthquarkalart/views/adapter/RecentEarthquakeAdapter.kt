...
class RecentEarthquakeAdapter (var context: Context,
private var dataList: MutableList<Earthquake_Data_Class>
) : RecyclerView.Adapter<RecentEarthquakeAdapter.RecentEarthquakeViewHolder>() {

    class RecentEarthquakeViewHolder(var binding: ItemBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecentEarthquakeViewHolder {
        var binding = ItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)

        return RecentEarthquakeViewHolder(binding)
    }

    override fun onBindViewHolder(holder: RecentEarthquakeViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            dataList[position].let{
                ...
                val eventTimeMillis = it.event_time
